...
.method public constructor <init>(Lcrittercism/android/bs;Lcrittercism/android/bs;Ljava/lang/String;Landroid/content/Context;Lcrittercism/android/au;)V
    ...
    .prologue
    .line 59
    invoke-direct {p0, p1, p2}, Lcrittercism/android/db;-><init>(Lcrittercism/android/bs;Lcrittercism/android/bs;)V

    .line 60
    iput-object p3, p0, Lcrittercism/android/cu;->c:Ljava/lang/String;

    .line 65
    iput-object p4, p0, Lcrittercism/android/cu;->b:Landroid/content/Context;

    .line 66
    iput-object p5, p0, Lcrittercism/android/cu;->a:Lcrittercism/android/au;
...
.method public final a(ZILorg/json/JSONObject;)V
    ...
    .line 144
    invoke-super {p0, p1, p2, p3}, Lcrittercism/android/db;->a(ZILorg/json/JSONObject;)V
    ...
    .line 148
    sget-object v0, Lcrittercism/android/dy$a;->b:Lcrittercism/android/dy$a;
    ...
    .line 154
    :goto_0
    iget-object v0, p0, Lcrittercism/android/cu;->a:Lcrittercism/android/au;

    invoke-interface {v0}, Lcrittercism/android/au;->m()Lcrittercism/android/du;
    ...
    invoke-virtual {v3, v2}, Lcrittercism/android/du;->a(Z)V
    ...
    iget-object v3, p0, Lcrittercism/android/cu;->a:Lcrittercism/android/au;

    invoke-direct {v0, v3}, Lcrittercism/android/cv;-><init>(Lcrittercism/android/au;)V

    const-string v3, "device_name"

    iget-object v4, p0, Lcrittercism/android/cu;->a:Lcrittercism/android/au;

    invoke-interface {v4}, Lcrittercism/android/au;->i()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v0, v3, v4}, Lcrittercism/android/cv;->a(Ljava/lang/String;Ljava/lang/String;)Lcrittercism/android/cv;

    move-result-object v0

    const-string v3, "pkg"

    iget-object v4, p0, Lcrittercism/android/cu;->b:Landroid/content/Context;
    ...
    iget-object v5, p0, Lcrittercism/android/cu;->c:Ljava/lang/String;
    ...
    new-instance v4, Lcrittercism/android/dk;

    const/4 v5, 0x0

    invoke-direct {v4, v0, v3, v5}, Lcrittercism/android/dk;-><init>(Lcrittercism/android/cx;Lcrittercism/android/dd;Lcrittercism/android/cz;)V

    invoke-virtual {v4}, Lcrittercism/android/dk;->run()V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1

    :goto_2
    iput-boolean v1, p0, Lcrittercism/android/cu;->f:Z
    ...
    iput-object v0, p0, Lcrittercism/android/cu;->d:Lorg/json/JSONObject;

    iget-object v0, p0, Lcrittercism/android/cu;->d:Lorg/json/JSONObject;

    if-eqz v0, :cond_3

    new-instance v0, Lcrittercism/android/h;

    iget-object v1, p0, Lcrittercism/android/cu;->d:Lorg/json/JSONObject;

    invoke-direct {v0, v1}, Lcrittercism/android/h;-><init>(Lorg/json/JSONObject;)V

    iget-object v1, p0, Lcrittercism/android/cu;->b:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcrittercism/android/cu;->e:Lorg/json/JSONObject;

    iget-object v0, p0, Lcrittercism/android/cu;->e:Lorg/json/JSONObject;

    if-eqz v0, :cond_4

    new-instance v0, Lcrittercism/android/bh;

    iget-object v1, p0, Lcrittercism/android/cu;->e:Lorg/json/JSONObject;
    ...
    .line 151
    :cond_5
    sget-object v0, Lcrittercism/android/dy$a;->c:Lcrittercism/android/dy$a;
    ...
    :cond_7
    iget-object v5, v3, Lcrittercism/android/du;->a:Landroid/content/SharedPreferences;
    ...
    iget-object v4, v3, Lcrittercism/android/du;->a:Landroid/content/SharedPreferences;
    ...
    invoke-virtual {v3, v0}, Lcrittercism/android/du;->a(Z)V
    :try_end_1
    ...
    invoke-static {v3}, Lcrittercism/android/dy;->b(Ljava/lang/String;)V
