...
{
  Context$9(Context paramContext) {}
  ...
  public Object call(Object paramObject)
  {
    ...
    synchronized (Context.access$200(this$0))
    {
      ...
      Context.access$100(this$0).debug(Context.access$000(this$0), "#_onApiPause()");
      if (!Context.access$300(this$0, "_onApiPause")) {
        return null;
      }
    ...
    {
      paramObject = new TrackItem(Context.access$200(this$0), "pause", ((Double)localMap.get("playhead")).doubleValue(), null, (ICallback)paramObject);
...
/* Location:
 * Qualified Name:     com.adobe.primetime.va.plugins.ah.engine.context.Context.9
