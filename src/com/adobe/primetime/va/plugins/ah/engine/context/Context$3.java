...
{
  Context$3(Context paramContext) {}
  ...
  public Object call(Object paramObject)
  {
    ...
    synchronized (Context.access$200(this$0))
    {
      ...
      Context.access$100(this$0).debug(Context.access$000(this$0), "#_onApiAnalyticsAdStart");
      if (!Context.access$300(this$0, "_onApiAnalyticsAdStart")) {
        return null;
      }
    ...
    {
      paramObject = new TrackItem(Context.access$200(this$0), "aa_ad_start", ((Double)localMap.get("playhead")).doubleValue(), null, (ICallback)paramObject);
...
/* Location:
 * Qualified Name:     com.adobe.primetime.va.plugins.ah.engine.context.Context.3
