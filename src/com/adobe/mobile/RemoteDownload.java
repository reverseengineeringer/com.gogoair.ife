...
class RemoteDownload
{
  ...
  private static boolean deleteCachedDataForURL(String paramString1, String paramString2)
  {
    boolean bool = true;
    ...
    {
      return bool;
      paramString1 = getFileForCachedURL(paramString1, paramString2);
    } while ((paramString1 != null) && (paramString1.delete()));
    return false;
  }
  
  protected static void deleteFilesForDirectoryNotInList(String paramString, List paramList)
  {
    if ((paramList == null) || (paramList.size() <= 0)) {
      deleteFilesInDirectory(paramString);
    }
    do
    {
      do
      {
        return;
        paramString = getDownloadCacheDirectory(paramString);
    ...
    while (paramList.hasNext()) {
      localArrayList.add(md5hash((String)paramList.next()));
    }
  ...
  protected static void deleteFilesInDirectory(String paramString)
  {
    paramString = getDownloadCacheDirectory(paramString);
    if (paramString == null) {}
    do
  ...
  protected static File getDownloadCacheDirectory(String paramString)
  {
    File localFile = new File(StaticMethods.getCacheDirectory(), paramString);
  ...
  private static String getEtagOfFile(String paramString)
  {
    ...
    paramString = splitPathExtension(getPathExtension(paramString));
  ...
  protected static File getFileForCachedURL(String paramString)
  {
    return getFileForCachedURL(paramString, "adbdownloadcache");
  }
  
  protected static File getFileForCachedURL(String paramString1, String paramString2)
  {
    if ((paramString1 == null) || (paramString1.length() < 1)) {}
    do
    {
      return null;
      paramString2 = getDownloadCacheDirectory(paramString2);
    } while (paramString2 == null);
    String[] arrayOfString = paramString2.list();
    if ((arrayOfString == null) || (arrayOfString.length < 1))
    {
      StaticMethods.logDebugFormat("Cached Files - Directory is empty (%s).", new Object[] { paramString2.getAbsolutePath() });
      return null;
    }
    String str1 = md5hash(paramString1);
    ...
    StaticMethods.logDebugFormat("Cached Files - This file has not previously been cached (%s).", new Object[] { paramString1 });
    return null;
  }
  
  private static long getLastModifiedOfFile(String paramString)
  {
    if ((paramString == null) || (paramString.length() < 1))
    {
    ...
    return Long.parseLong(paramString[0]);
  }
  
  private static File getNewCachedFile(String paramString1, Date paramDate, String paramString2, String paramString3)
  {
    if ((paramString1 == null) || (paramString1.length() < 1)) {
    ...
    do
    {
      do
      {
        ...
        paramString3 = getDownloadCacheDirectory(paramString3);
      } while (paramString3 == null);
      str = md5hash(paramString1);
    } while ((str == null) || (str.length() < 1));
    return new File(paramString3.getPath() + File.separator + md5hash(paramString1) + "." + paramDate.getTime() + "_" + paramString2);
  }
  
  private static String getPathExtension(String paramString)
  {
    if ((paramString == null) || (paramString.length() < 1))
    {
      StaticMethods.logWarningFormat("Cached File - Path was null or empty for Cache File", new Object[0]);
  ...
  private static String md5hash(String paramString)
  {
    if ((paramString == null) || (paramString.length() < 1)) {
      return null;
    }
    ...
    {
      StaticMethods.logErrorFormat("Cached Files - unable to get md5 hash (%s)", new Object[] { paramString.getMessage() });
      return null;
    }
    catch (UnsupportedEncodingException paramString)
    {
      StaticMethods.logErrorFormat("Cached Files - Unsupported Encoding: UTF-8 (%s)", new Object[] { paramString.getMessage() });
    }
    return null;
  }
  
  protected static void remoteDownloadAsync(String paramString, int paramInt1, int paramInt2, RemoteDownloadBlock paramRemoteDownloadBlock)
  {
    remoteDownloadAsync(paramString, paramInt1, paramInt2, paramRemoteDownloadBlock, "adbdownloadcache");
  }
  
  protected static void remoteDownloadAsync(String paramString1, int paramInt1, int paramInt2, RemoteDownloadBlock paramRemoteDownloadBlock, String paramString2)
  {
    new Thread(new DownloadFileTask(paramString1, paramRemoteDownloadBlock, paramInt1, paramInt2, paramString2, null)).start();
  }
  
  protected static void remoteDownloadAsync(String paramString, RemoteDownloadBlock paramRemoteDownloadBlock)
  {
    remoteDownloadAsync(paramString, 10000, 10000, paramRemoteDownloadBlock, "adbdownloadcache");
  }
  
  protected static void remoteDownloadAsync(String paramString1, String paramString2, RemoteDownloadBlock paramRemoteDownloadBlock)
  {
    remoteDownloadAsync(paramString1, 10000, 10000, paramRemoteDownloadBlock, paramString2);
  }
  
  protected static void remoteDownloadSync(String paramString, int paramInt1, int paramInt2, RemoteDownloadBlock paramRemoteDownloadBlock)
  {
    remoteDownloadSync(paramString, paramInt1, paramInt2, paramRemoteDownloadBlock, "adbdownloadcache");
  }
  
  protected static void remoteDownloadSync(String paramString1, int paramInt1, int paramInt2, RemoteDownloadBlock paramRemoteDownloadBlock, String paramString2)
  {
    new DownloadFileTask(paramString1, paramRemoteDownloadBlock, paramInt1, paramInt2, paramString2, null).run();
  }
  
  protected static void remoteDownloadSync(String paramString, RemoteDownloadBlock paramRemoteDownloadBlock)
  {
    remoteDownloadSync(paramString, 10000, 10000, paramRemoteDownloadBlock, "adbdownloadcache");
  }
  
  protected static void remoteDownloadSync(String paramString1, String paramString2, RemoteDownloadBlock paramRemoteDownloadBlock)
  {
    remoteDownloadSync(paramString1, 10000, 10000, paramRemoteDownloadBlock, paramString2);
  }
  
  private static String[] splitPathExtension(String paramString)
  {
    if ((paramString == null) || (paramString.length() < 1))
    {
    ...
    {
      StaticMethods.logWarningFormat("Cached File - Invalid Extension on Cache File (%s)", new Object[] { paramString });
      return null;
    }
    return arrayOfString;
  }
  
  protected static boolean stringIsUrl(String paramString)
  {
    ...
    implements Runnable
  {
    ...
    private DownloadFileTask(String paramString1, RemoteDownload.RemoteDownloadBlock paramRemoteDownloadBlock, int paramInt1, int paramInt2, String paramString2)
    {
      url = paramString1;
  ...
  protected static abstract interface RemoteDownloadBlock
  {
    public abstract void call(boolean paramBoolean, File paramFile);
  }
}

/* Location:
 * Qualified Name:     com.adobe.mobile.RemoteDownload
