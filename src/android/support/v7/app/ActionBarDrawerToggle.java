  ...
  implements DrawerLayout.DrawerListener
{
  ...
  ActionBarDrawerToggle(Activity paramActivity, Toolbar paramToolbar, DrawerLayout paramDrawerLayout, Drawable paramDrawable, @StringRes int paramInt1, @StringRes int paramInt2)
  {
    ...
    label180:
    for (mSlider = new DrawerArrowDrawableToggle(paramActivity, mActivityImpl.getActionBarThemedContext());; mSlider = ((DrawerToggle)paramDrawable))
    {
