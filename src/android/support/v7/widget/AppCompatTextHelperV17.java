  ...
  extends AppCompatTextHelper
{
  ...
  void loadFromAttributes(AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    if (paramAttributeSet.hasValue(0)) {
      mDrawableStartTint = createTintInfo(localContext, localTintManager, paramAttributeSet.getResourceId(0, 0));
    }
    if (paramAttributeSet.hasValue(1)) {
      mDrawableEndTint = createTintInfo(localContext, localTintManager, paramAttributeSet.getResourceId(1, 0));
    }
