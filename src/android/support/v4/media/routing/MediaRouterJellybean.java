...
class MediaRouterJellybean
{
    ...
    extends MediaRouter.Callback
  {
    ...
    public CallbackProxy(MediaRouterJellybean.Callback paramCallback)
    {
  ...
  static class VolumeCallbackProxy
    extends MediaRouter.VolumeCallback
  {
    protected final MediaRouterJellybean.VolumeCallback mCallback;
    
    public VolumeCallbackProxy(MediaRouterJellybean.VolumeCallback paramVolumeCallback)
    {
