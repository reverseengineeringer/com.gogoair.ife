...
{
  public static void addTargets(Object paramObject, ArrayList paramArrayList)
  {
    int i = 0;
  ...
  public static void addTransitionTargets(Object paramObject1, Object paramObject2, View paramView1, ViewRetriever paramViewRetriever, View paramView2, EpicenterView paramEpicenterView, Map paramMap1, ArrayList paramArrayList1, Map paramMap2, Map paramMap3, ArrayList paramArrayList2)
  {
    if ((paramObject1 != null) || (paramObject2 != null))
    {
      ...
      if (paramObject2 != null) {
        setSharedElementTargets(paramObject2, paramView2, paramMap2, paramArrayList2);
      }
      if (paramViewRetriever != null) {
        paramView1.getViewTreeObserver().addOnPreDrawListener(new FragmentTransitionCompat21.2(paramView1, (Transition)paramObject1, paramView2, paramViewRetriever, paramMap1, paramMap3, paramArrayList1));
      }
  ...
  private static void bfsAddViewChildren(List paramList, View paramView)
  {
  ...
  public static Object captureExitingViews(Object paramObject, View paramView1, ArrayList paramArrayList, Map paramMap, View paramView2)
  {
  ...
  private static void captureTransitioningViews(ArrayList paramArrayList, View paramView)
  {
  ...
  public static void cleanupTransitions(View paramView1, View paramView2, Object paramObject1, ArrayList paramArrayList1, Object paramObject2, ArrayList paramArrayList2, Object paramObject3, ArrayList paramArrayList3, Object paramObject4, ArrayList paramArrayList4, Map paramMap)
  {
    paramObject1 = (Transition)paramObject1;
  ...
  public static void findNamedViews(Map paramMap, View paramView)
  {
    if (paramView.getVisibility() == 0)
    {
  ...
  public static void removeTargets(Object paramObject, ArrayList paramArrayList)
  {
    paramObject = (Transition)paramObject;
    int i;
    if ((paramObject instanceof TransitionSet))
  ...
  public static void setSharedElementTargets(Object paramObject, View paramView, Map paramMap, ArrayList paramArrayList)
  {
    paramObject = (TransitionSet)paramObject;
