...
public class NotificationCompat
{
  ...
  private static void addActionsToBuilder(NotificationBuilderWithActions paramNotificationBuilderWithActions, ArrayList paramArrayList)
  {
  ...
  static abstract interface NotificationCompatImpl
  {
    ...
    public abstract NotificationCompat.Action[] getActionsFromParcelableArrayList(ArrayList paramArrayList);
    ...
    public abstract ArrayList getParcelableArrayListForActions(NotificationCompat.Action[] paramArrayOfAction);
    ...
    extends NotificationCompat.NotificationCompatImplKitKat
  {
    ...
    public NotificationCompat.Action[] getActionsFromParcelableArrayList(ArrayList paramArrayList)
    {
    ...
    public ArrayList getParcelableArrayListForActions(NotificationCompat.Action[] paramArrayOfAction)
    {
