  ...
  implements FragmentManager.BackStackEntry, Runnable
{
  ...
  private TransitionState beginTransition(SparseArray paramSparseArray1, SparseArray paramSparseArray2, boolean paramBoolean)
  {
    int n = 0;
  ...
  private void calculateFragments(SparseArray paramSparseArray1, SparseArray paramSparseArray2)
  {
  ...
  private void callSharedElementEnd(TransitionState paramTransitionState, Fragment paramFragment1, Fragment paramFragment2, boolean paramBoolean, ArrayMap paramArrayMap)
  {
    if (paramBoolean) {}
  ...
  private static Object captureExitingViews(Object paramObject, Fragment paramFragment, ArrayList paramArrayList, ArrayMap paramArrayMap, View paramView)
  {
  ...
  private boolean configureTransitions(int paramInt, TransitionState paramTransitionState, boolean paramBoolean, SparseArray paramSparseArray1, SparseArray paramSparseArray2)
  {
  ...
  private ArrayMap mapEnteringSharedElements(TransitionState paramTransitionState, Fragment paramFragment, boolean paramBoolean)
  {
    ArrayMap localArrayMap = new ArrayMap();
  ...
  private ArrayMap mapSharedElementsIn(TransitionState paramTransitionState, boolean paramBoolean, Fragment paramFragment)
  {
  ...
  private void prepareSharedElementTransition(TransitionState paramTransitionState, View paramView, Object paramObject, Fragment paramFragment1, Fragment paramFragment2, boolean paramBoolean, ArrayList paramArrayList)
  {
  ...
  private static ArrayMap remapNames(ArrayList paramArrayList1, ArrayList paramArrayList2, ArrayMap paramArrayMap)
  {
  ...
  private ArrayMap remapSharedElements(TransitionState paramTransitionState, Fragment paramFragment, boolean paramBoolean)
  {
  ...
  private void setBackNameOverrides(TransitionState paramTransitionState, ArrayMap paramArrayMap, boolean paramBoolean)
  {
    int i;
    int j;
    label13:
  ...
  private void setEpicenterIn(ArrayMap paramArrayMap, TransitionState paramTransitionState)
  {
  ...
  private static void setFirstOut(SparseArray paramSparseArray, Fragment paramFragment)
  {
    if (paramFragment != null)
    {
      int i = mContainerId;
  ...
  private void setLastIn(SparseArray paramSparseArray, Fragment paramFragment)
  {
    if (paramFragment != null)
    {
      int i = mContainerId;
  ...
  private static void setNameOverride(ArrayMap paramArrayMap, String paramString1, String paramString2)
  {
    int i;
  ...
  private void setNameOverrides(TransitionState paramTransitionState, ArrayMap paramArrayMap, boolean paramBoolean)
  {
  ...
  private static void setNameOverrides(TransitionState paramTransitionState, ArrayList paramArrayList1, ArrayList paramArrayList2)
  {
  ...
  public void calculateBackFragments(SparseArray paramSparseArray1, SparseArray paramSparseArray2)
  {
    if (!mManager.mContainer.onHasView()) {}
    Op localOp;
    do
  ...
  public TransitionState popFromBackStack(boolean paramBoolean, TransitionState paramTransitionState, SparseArray paramSparseArray1, SparseArray paramSparseArray2)
  {
    if (FragmentManagerImpl.DEBUG)
    {
