  ...
  extends LoaderManager
{
  ...
  final class LoaderInfo
    implements Loader.OnLoadCanceledListener, Loader.OnLoadCompleteListener
  {
    final Bundle mArgs;
    ...
    public LoaderInfo(int paramInt, Bundle paramBundle, LoaderManager.LoaderCallbacks paramLoaderCallbacks)
    {
      mId = paramInt;
      mArgs = paramBundle;
      mCallbacks = paramLoaderCallbacks;
