  ...
  public final void a()
  {
    ...
    synchronized (c.p)
    {
      if (c.B < 10)
      {
        ...
        if (c.p.a())
        {
          localObject1 = new JSONArray().put(((bk)localObject1).a());
          new dk(new cv(az.a).a(br.b.f(), (JSONArray)localObject1), new dd(new dc(c.u.b(), "/android_v2/handle_exceptions").a()), null).run();
          localObject1 = c;
          B += 1;
          c.p.b();
        }
