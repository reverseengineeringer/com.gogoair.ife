  ...
  implements bt
{
  ...
  public bi(Context arg1, au paramau, bs parambs1, bs parambs2, bs parambs3, bs parambs4, String paramString)
  {
    k = ???;
    f = parambs1;
    g = parambs2;
  ...
  public final void a()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          localObject2 = new dd(new URL(j)).a();
        ...
        catch (GeneralSecurityException localGeneralSecurityException)
        {
          new StringBuilder("Request failed for ").append(j);
          dy.a();
          dy.a(localGeneralSecurityException);
        }
      }
