  ...
  extends db
{
  ...
  public cu(bs parambs1, bs parambs2, String paramString, Context paramContext, au paramau)
  {
    ...
    for (;;)
    {
      ...
      if (localObject1 != null)
      {
        ...
        if (localObject2 == null) {
          ((du)localObject1).a(false);
        }
      }
      else if (paramJSONObject.optInt("needPkg", 0) != 1) {}
      try
      {
        new dk(new cv(a).a("device_name", a.i()).a("pkg", b.getPackageName()), new dd(new dc(c, "/android_v2/update_package_name").a()), null).run();
        f = true;
